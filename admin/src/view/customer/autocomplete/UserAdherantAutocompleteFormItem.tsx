...
import UserNewFormModal from 'src/view/customer/new/UserNewFormModal';
import AutocompleteInMemoryFormItem from 'src/view/shared/form/items/AutocompleteInMemoryFormItem';
import { useFormContext } from 'react-hook-form';
import { useSelector } from 'react-redux';
import selectors from 'src/modules/user/userSelectors';

function UserAdherantAutocompleteFormItem(props) {
  ...
  const fetchFn = (value, limit) => {
    return UserService.listAdherantAutocomplete(value, limit);
  };
...
export default UserAdherantAutocompleteFormItem;
