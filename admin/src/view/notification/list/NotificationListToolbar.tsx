...
function NotificationListToolbar(props) {
  const [
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="notification-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="notification-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
      ...
      {hasPermissionToCreate && (
        <Link to="/notification/new">
          <span
            ...
            data-for="notification-list-toolbar-new-tooltip"
          >
            <button
              className="btn btn-primary"
              type="button"
            ...
            <ReactTooltip id="notification-list-toolbar-new-tooltip" />
          </span>
        </Link>
      )}
