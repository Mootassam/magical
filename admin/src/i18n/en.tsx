  ...
  entities: {
    ...
    product: {
      ...
      importHuggingFace: {
        ...
        backgroundImportStarted: ' The large general merchandise catalog is still importing in the background - progress is shown below.',
        backgroundImportResumed: ' The large general merchandise catalog import was interrupted earlier and has resumed from where it left off - progress is shown below.',
        backgroundImportAlreadyRunning: 'The large general merchandise catalog is still importing from an earlier run - progress is shown below.',
        backgroundImportAlreadyCompleted: 'The large general merchandise catalog has already been fully imported.',
        progressRunning: 'Importing general merchandise catalog: {0} rows processed, {1} products created so far…',
        progressCompleted: 'General merchandise catalog import complete: {0} rows processed, {1} products created.',
        progressFailed: 'General merchandise catalog import stopped unexpectedly ({0}). Click "Import Sample Products" again to resume from where it left off.',
      },
    },
