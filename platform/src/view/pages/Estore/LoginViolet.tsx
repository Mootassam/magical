        ...
        <div className="logo-wrap">
          <div className="logo-badge">
            <svg viewBox="0 0 200 220" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M60 40 h70 a10 10 0 0 1 10 10 v110 a10 10 0 0 1 -10 10 h-70 a10 10 0 0 1 -10 -10 v-110 a10 10 0 0 1 10 -10 z" fill="#241b45" />
              <path d="M78 40 v-8 a17 17 0 0 1 34 0 v8" fill="none" stroke="#241b45" strokeWidth="8" />
              <path d="M78 40 v-8 a17 17 0 0 1 34 0 v8" fill="none" stroke="#faf8ff" strokeWidth="3" />
              ...
              <circle cx="82" cy="182" r="7" fill="#241b45" />
              <circle cx="118" cy="182" r="7" fill="#241b45" />
            </svg>
          </div>
      ...
      <style>{`
        ...
        *{box-sizing:border-box; margin:0; padding:0;}
        ...
        body{
          ...
          background: radial-gradient(circle at 30% 15%, #f0eafd 0%, var(--page-bg) 55%, #ece5fb 100%);
          min-height:100vh;
          display:flex;
          align-items:center;
        ...
        .card{
          ...
          box-shadow:0 20px 50px rgba(91,33,214,0.12), 0 0 0 1px rgba(139,92,246,0.03) inset;
        }
        ...
        .logo-badge{
          ...
          align-items:center;
          justify-content:center;
          box-shadow:0 8px 24px rgba(139,92,246,0.20), 0 0 0 1px rgba(139,92,246,0.14);
          overflow:hidden;
        }
        ...
        input::placeholder{ color:#aaa3c4; }
