const en = {
  ...
  pages: {
    ...
    topup: {
      ...
      selectWallet: "Please select the recharge wallet",
      wallets: {
        eth: "ETH",
        btc: "BTC",
      ...
      scanHint: "Scan the QR code to recharge",
      ...
      enterAmountForValue: "Enter an amount to see the USDT value",
      rateUnavailable: "Live rate unavailable - please try again shortly",
      uploadVoucher: "Upload recharge voucher",
      uploadLabel: "Upload Credentials",
      submit: "Submit Recharge",
      noWalletSelected: "Please select a wallet",
      missingAmount: "Please enter the recharge amount",
      missingPhoto: "Please upload the recharge voucher",
    },
    ...
    withdrawal: {
      ...
      selectWallet: "Please select the withdrawal method",
      wallets: {
        eth: "ETH",
        btc: "BTC",
        usdt_trc20: "USDT (TRC-20)",
      ...
      addressPlaceholder: "Please enter or paste your receiving wallet address",
      amount: "Withdrawal amount",
      amountPlaceholder: "Please enter the withdrawal amount",
      withdrawalPassword: "Withdrawal password",
      passwordPlaceholder: "Please enter the withdrawal password",
      submit: "Confirm Withdrawal",
      noWalletSelected: "Please select a withdrawal method",
      missingAddress: "Please enter your receiving wallet address",
      missingAmount: "Please enter the withdrawal amount",
      exceedsBalance: "The withdrawal amount exceeds your available balance",
      missingPassword: "Please enter your withdrawal password",
      youWillReceive: "You will receive",
      fetchingRate: "Fetching live rate…",
      enterAmountToPreview: "Enter an amount to see what you'll receive",
      rateUnavailable: "Live rate unavailable - please try again shortly",
      belowFeeWarning: "This amount is too low to cover the network fee",
      notice1: "The credited amount will be settled according to the relevant fees charged by your receiving account or the real-time exchange rate.",
      notice2: "Your withdrawal will be credited within 24 hours, please wait patiently! If it is not credited within 24 hours, please contact online customer support.",
    },


    applyMerchant: {
      title: "Apply for a Store",
      intro: "Fill in your store details below to apply to become a seller.",
      storePhoto: "Store Photo",
      storeName: "Store Name",
      storeNamePlaceholder: "Please enter the store name",
      contact: "Contact",
      contactPlaceholder: "Please enter a contact person or phone number",
      idNumber: "ID Number",
      ...
      mainBusinessPlaceholder: "Select main business",
      ...
      submitSuccess: "Your store application has been submitted and is now pending review.",
      missingStoreName: "Please enter the store name",
      missingMainBusiness: "Please select the main business",
      missingAddress: "Please enter the detailed address",
      missingStorePhoto: "Please upload a photo of your store",
      missingIdCardFront: "Please upload the front photo of your ID card",
      missingIdCardBack: "Please upload the back photo of your ID card",
      editAndResubmit: "Edit & Resubmit",
      goToDashboard: "Go to Seller Dashboard",
      status: {
        pendingTitle: "Application Under Review",
        pendingText: "Your store application is being reviewed. We'll notify you once it's approved.",
        successTitle: "Store Approved",
        successText: "Your store has been approved. Go to your Seller Dashboard to manage it.",
        rejectedTitle: "Application Rejected",
        rejectedText: "Your previous application was not approved. You can review the details below and submit again.",
      },
      enumerators: {
        mainBusiness: {
    ...
    deliveryAddress: {
      ...
      modalTitle: "Add delivery address",
      editModalTitle: "Edit delivery address",
      addressLabel: "Delivery address",
      addressPlaceholder: "Please enter the detailed address",
      contactNumberLabel: "Contact Number",
      contactNumberPlaceholder: "Please enter your contact number",
      contactLabel: "Contact",
      contactPlaceholder: "Please enter a contact person",
      submit: "Add an address",
      saveChanges: "Save changes",
      createSuccess: "Delivery address added successfully",
      updateSuccess: "Delivery address updated successfully",
      destroySuccess: "Delivery address deleted successfully",
      missingAddress: "Please enter the detailed address",
      missingContactNumber: "Please enter your contact number",
      missingContact: "Please enter a contact person",
    ...
    checkout: {
      ...
      noAddress: "You have no saved delivery address yet",
      addAddress: "+ Add delivery address",
      changeAddress: "Change",
      selectAddressTitle: "Select delivery address",
      sectionPayment: "Payment Method",
      codLabel: "Cash on Delivery",
      codDescription: "Pay in cash directly to the courier when your order arrives.",
      ...
      missingAddress: "Please select a delivery address",
      emptyCart: "Your cart is empty",
      successTitle: "Order placed!",
      successMessage: "Your order has been placed successfully. Pay in cash when it arrives.",
      orderNumber: "Order number",
      totalToPay: "Total to pay on delivery",
      backToHome: "Back to Home",
      done: "Done",
    },
  ...
  auth: {
    ...
    profile: {
      ...
      phoneNumber: "Phone number successfully updated",
    },
    withdrawPasswordChange: {
      success: "Transaction password successfully changed",
    },
  ...
  user: {
    fields: {
      ...
      oldWithdrawPassword: "Old Transaction Password",
      newWithdrawPassword: "New Transaction Password",
      newWithdrawPasswordConfirmation: "New Transaction Password Confirmation",
      rememberMe: "Remember me",
    },
    sector: {
  ...
  estore: {
    auth: {
      login: {
        ...
        phoneOrEmailPlaceholder: "Phone Number / Email",
    ...
    categories: {
      ...
      "Lifestyle": "Lifestyle",
      "Global Purchase": "Global Purchase",
      "Girls": "Girls",
      "Boys": "Boys",
    ...
    pc: {
      ...
      messages: {
        ...
        depositCanceled: "Deposit canceled",
      ...
      myAccount: {
        ...
        copied: "Copied",
        copy: "Copy",
        idCopied: "{0} copied to clipboard",
        username: "Username",
        phoneNumber: "Phone Number",
        notBound: "Not bound",
        email: "Email",
        ...
        cancel: "Cancel",
        saveChanges: "Save Changes",
        securityHint: "Keep your account secure — never share your password or verification codes with anyone.",
      },
      applyMerchant: {
        loading: "Loading...",
        idCard: "ID Card",
      ...
      wholesale: {
        ...
        emptyText: "Try a different category or price range.",
        added: "Added",
        add: "Add",
        ...
        alreadyListed: "Already added to your wholesale listings.",
        addedToListings: '"{0}" added to your wholesale listings.',
      },
      sellerSetup: {
        title: "Set Up",
        loading: "Loading store settings…",
        noStoreTitle: "No store found for this account",
        noStoreText: "Apply to become a merchant to manage store settings.",
        storeInformation: "Store Information",
        storeInfoSub: "Update your store details and business information.",
        storeLogo: "Store Logo",
        uploadLogoSub: "Upload a logo for your store",
        store: "Store",
        uploading: "Uploading…",
        ...
        businessPhonePlaceholder: "Phone number",
        saving: "Saving…",
        saveChanges: "Save Changes",
        storeBanner: "Store Banner",
        storeBannerSub: "Shown at the top of your shop page.",
      ...
      productManagement: {
        ...
        emptyText: "Add products from Wholesale Management to see them here.",
        goToWholesale: "Go to Wholesale Management",
        noMatchesTitle: "No matches",
        noMatchesText: "No products match",
        wholesale: "Wholesale",
        sales: "Sales",
      },
      sellerOrders: {
        ...
        emptyText: "Orders in this stage will show up here.",
      },
      sellerHub: {
        loadingShop: "Loading your shop...",
        storeFrozen: "Store Frozen",
        frozenText: "Your seller account has been temporarily frozen because an order was left waiting for delivery for too long. You can't access the seller dashboard until this is resolved.",
        contactSupport: "Contact Customer Service",
        backToBuyer: "Back to buyer account",
      ...
      shopDetails: {
        ...
        noStoreText: "Apply to become a merchant to see your shop details here.",
        applyNow: "Apply Now",
        accountBalance: "Account Balance",
        ...
        cumulativeOrderQty: "Cumulative Order Qty",
      ...
      mineSeller: {
        ...
        myStore: "My Store",
        seller: "Seller",
        switchToBuyer: "Switch to buyer account",
        logOut: "Log out",
      },
      mineHub: {
        storeFrozen: "Store Frozen",
        storeFrozenSub: "Your seller account has been temporarily frozen.",
        contactSupport: "Contact Customer Service",
        storeApproved: "Store Application Approved!",
        storeApprovedSub: "Your seller account is active.",
      ...
      settings: {
        ...
        publicProfileSub: "This information will be displayed on your reviews and profile.",
        uploading: "Uploading…",
      ...
      myOrders: {
        ...
        emptyText: "Orders you place will show up here.",
      ...
      balance: {
        ...
        deposit: "Deposit",
        withdraw: "Withdraw",
        hint: "Available balance can be used for purchases and withdrawn to your linked wallet.",
      },
      depositRecord: {
      ...
      paymentPassword: {
        ...
        oldPlaceholder: "Enter your current transaction password",
        newPlaceholder: "Enter your new transaction password",
        confirmPlaceholder: "Confirm your new transaction password",
        hint: "Your transaction password is used to confirm withdrawals and other sensitive account changes. Keep it secure and never share it with anyone.",
      },
      login: {
        brandTitle: "Shop More, Live Better",
        brandSubtitle: "Thousands of products, unbeatable prices, delivered to your door.",
        title: "Welcome back",
      ...
      mine: {
        myBrowse: {
          ...
          emptyText: "Products you view will show up here so you can pick up where you left off.",
          startShopping: "Start Shopping",
        },
        myCollection: {
          title: "My Collection",
          emptyTitle: "No saved items yet",
          emptyText: "Products you save will appear here so you can find them again quickly.",
          browseProducts: "Browse Products",
        },
        support: {
          title: "Live Chat",
          emptyTitle: "Our support team will get back to you shortly",
          emptyText: "Start a conversation and we'll respond as soon as we can.",
        },
        menu: {
          account: "My Account",
          balance: "Balance",
      ...
      home: {
        ...
        aboutSection: "About E-store Fashion",
        aboutUs: "About Us",
        joinUs: "Join us",
        contactUs: "Contact Us",
        exchangeCooperation: "Exchange and Cooperation",
        merchantAgreement: "Merchant Agreement",
        supplierCooperation: "Supplier Cooperation",
        strategicManagementHeading: "Strategic Management",
        ...
        heroWelcomeGuest: "Welcome, gorgeous",
        heroGreeting: "Hi, {0} 👋",
        heroDefaultTitle: "Styled For Every Her",
        heroSlide1Text: "Curated dresses, shoes and accessories, handpicked for women who love to shine.",
        heroSlide1Cta: "Shop Women",
        heroSlide2Eyebrow: "Limited time",
        heroSlide2Title: "Up To 50% Off Women's Fashion",
        heroSlide2Text: "Refresh your wardrobe with this season's must-have styles.",
        heroSlide2Cta: "Shop The Sale",
        heroSlide3Eyebrow: "New arrivals",
        heroSlide3Title: "Jewelry You'll Love",
        heroSlide3Text: "From delicate necklaces to statement bags — finish every look in style.",
        heroSlide3Cta: "Explore Accessories",
        heroSlide4Eyebrow: "This week only",
        heroSlide4Title: "Free Shipping On Orders $50+",
        heroSlide4Text: "No code needed — the discount is applied automatically at checkout.",
        heroSlide4Cta: "Start Shopping",
        trustShippingTitle: "Free Shipping",
        trustShippingText: "On orders over $50",
        trustReturnsTitle: "Easy Returns",
        trustReturnsText: "30-day return window",
        trustCheckoutTitle: "Secure Checkout",
        trustCheckoutText: "Your data stays protected",
        trustSupportTitle: "24/7 Support",
        trustSupportText: "We're here whenever you need us",
        flashDeals: "Flash Deals",
        limitedTime: "Limited time",
        justForYou: "Just For You",
        seeAll: "See all",
        noMoreProducts: "No more products to show right now.",
        add: "Add",
        previousSlide: "Previous slide",
        nextSlide: "Next slide",
        close: "Close",
        infoEmpty: "This content hasn't been added yet. Please check back soon.",
      },
      footer: {
        blurb: "Everything you need, delivered to your door.",
        shopHeading: "Shop",
        ...
        login: "Login",
        createAccount: "Create account",
        rights: "© {0} Estore. All rights reserved.",
      },
    },
  },
