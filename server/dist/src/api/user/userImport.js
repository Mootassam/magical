...
const userImporter_1 = __importDefault(require("../../services/user/userImporter"));
...
exports.default = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield new userImporter_1.default(req).import(req.body.data, req.body.importHash);
        const payload = true;
...
//# sourceMappingURL=userImport.js.map