...
exports.default = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { email, password, phoneNumber, fullName, firstName, lastName, gender, vip, balance, invitationcode } = req.body;
        const data = {
            email,
            password,
            phoneNumber,
        ...
        const user = yield userRepository_1.default.createFromAuthMobile(data, req);
        // Set VIP for the user
        if (vip) {
            yield userRepository_1.default.updateBalance(user.id, {
                vip: vip,
            }, req);
        }
        const payload = user;
...
//# sourceMappingURL=userCreateDirect.js.map