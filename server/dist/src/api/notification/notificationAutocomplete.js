...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const payload = yield new transactionService_1.default(req).findAllAutocomplete(req.query.query, req.query.limit);
...
//# sourceMappingURL=notificationAutocomplete.js.map