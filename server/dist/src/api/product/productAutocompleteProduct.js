...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const payload = yield new productService_1.default(req).findAllAutocompleteProduct(req.query.query, req.query.limit);
...
//# sourceMappingURL=productAutocompleteProduct.js.map