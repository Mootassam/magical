...
class AuthService {
    static signupMobile(email, password, phoneNumber, withdrawPassword, invitationcode, invitationToken, tenantId, gender, options = {}, req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const checkrefCode = yield userRepository_1.default.checkRefcode(invitationcode, options);
                if (!checkrefCode) {
                    throw new Error400_1.default(options.language, "auth.invitationCode");
                }
                ...
                const token = jsonwebtoken_1.default.sign({ id: newUser.id }, config_1.getConfig().AUTH_JWT_SECRET, {
                    expiresIn: config_1.getConfig().AUTH_JWT_EXPIRES_IN,
                });
                yield mongooseRepository_1.default.commitTransaction(session);
                return token;
            }
    ...
    static signup(email, password, username, phoneNumber, withdrawPassword, invitationcode, gender, invitationToken, tenantId, options = {}, req) {
        return __awaiter(this, void 0, void 0, function* () {
            const session = yield mongooseRepository_1.default.createSession(options.database);
            try {
                email = email.toLowerCase();
    ...
    static signin(email, password, invitationToken, tenantId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const token = jsonwebtoken_1.default.sign({ id: user.id }, config_1.getConfig().AUTH_JWT_SECRET, {
                    expiresIn: config_1.getConfig().AUTH_JWT_EXPIRES_IN,
                });
                yield mongooseRepository_1.default.commitTransaction(session);
                return token;
    ...
    static handleOnboardMobile(currentUser, invitationToken, tenantId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isMultiTenantViaSubdomain = ["multi", "multi-with-subdomain"].includes(config_1.getConfig().TENANT_MODE) &&
                tenantId;
