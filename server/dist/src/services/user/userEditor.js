...
class UserEditor {
    ...
    update(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this._updateUserAtDatabase();
    ...
    _updateAtDatabase() {
        return __awaiter(this, void 0, void 0, function* () {
            yield tenantUserRepository_1.default.updateRoles(this.options.currentTenant.id, this.data.id, this.data.roles, this.options, this.data.status);
        });
    }
    _updateUserAtDatabase() {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            yield userRepository_1.default.updateUser(this.options.currentTenant.id, this.data.id, this.data.fullName, this.data.phoneNumber, this.data.passportNumber, this.data.nationality, this.data.country, this.data.passportPhoto, this.data.balance, this.data.minbalance, this.data.vip.id, this.options, this.data.status, this.data.product, this.data.itemNumber, (_b = (_a = this.data) === null || _a === void 0 ? void 0 : _a.prizes) === null || _b === void 0 ? void 0 : _b.id, (_c = this.data) === null || _c === void 0 ? void 0 : _c.prizesNumber, this.data.withdrawPassword, this.data.score, this.data.grab, this.data.withdraw, this.data.freezeblance, this.data.preferredcoin, this.data.productItemMappings, this.data.tasksDone, this.data.photoProfile, this.data.notification);
        });
    }
    /**
