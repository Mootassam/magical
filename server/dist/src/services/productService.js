...
class ProductServices {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (const id of ids) {
                    ...
                    yield recordRepository_1.default.destroyAll(id, Object.assign(Object.assign({}, this.options), { session }));
                }
                yield mongooseRepository_1.default.commitTransaction(session);
            }
            catch (error) {
    ...
    findAllAutocompleteProduct(search, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            return productRepository_1.default.findAllAutocompleteProduct(search, limit, this.options);
        });
    }
    ...
    grapOrders(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return productRepository_1.default.grapOrders(this.options);
            }
            catch (error) {
                yield mongooseRepository_1.default.abortTransaction(session);
                throw error;
