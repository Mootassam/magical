...
class TenantService {
     ...
     * to new users.
     */
    createOrJoinDefaultMobile({ roles }, session) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (tenant) {
                ...
                return yield tenantUserRepository_1.default.createMobile(tenant, this.options.currentUser, roles, Object.assign(Object.assign({}, this.options), { session }));
            }
            ...
            yield tenantUserRepository_1.default.createMobile(record, this.options.currentUser, [roles_1.default.values.admin], Object.assign(Object.assign({}, this.options), { session }));
        });
    }
