...
class CompanyRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const list = yield company_1.default(options.database).find();
            let record;
            if (list && list.length > 0) {
                this.update(list[0]._id, data, options);
            }
            else {
                [record] = yield company_1.default(options.database).create([
    ...
    static findContact(options) {
        return __awaiter(this, void 0, void 0, function* () {
            const record = yield company_1.default(options.database).find();
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            let record = yield mongooseRepository_1.default.wrapWithSessionIfExists(company_1.default(options.database).findOne({
                _id: id,
            ...
            yield company_1.default(options.database).updateOne({ _id: id }, Object.assign(Object.assign({}, data), { updatedBy: mongooseRepository_1.default.getCurrentUser(options).id }), options);
    ...
    static destroy(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield company_1.default(options.database).deleteOne({ _id: id }, options);
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            const records = yield company_1.default(options.database)
                .find({
                _id: { $in: ids },
                tenant: currentTenant.id,
            })
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            return mongooseRepository_1.default.wrapWithSessionIfExists(company_1.default(options.database).countDocuments(Object.assign(Object.assign({}, filter), { tenant: currentTenant.id })), options);
        });
    }
    ...
    static findAndCountAll({ filter, limit = 0, offset = 0, orderBy = "" }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let rows = yield company_1.default(options.database)
                .find(criteria)
                .skip(skip)
                .limit(limitEscaped)
                .sort(sort);
            const count = yield company_1.default(options.database).countDocuments(criteria);
    ...
    static _createAuditLog(action, id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            yield auditLogRepository_1.default.log({
                entityName: company_1.default(options.database).modelName,
                entityId: id,
                action,
                values: data,
            }, options);
