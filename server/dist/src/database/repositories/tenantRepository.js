...
const mandat_1 = __importDefault(require("../models/mandat"));
const categorieMouv_1 = __importDefault(require("../models/categorieMouv"));
const mouvements_1 = __importDefault(require("../models/mouvements"));
const campagne_1 = __importDefault(require("../models/campagne"));
const detailsCampagne_1 = __importDefault(require("../models/detailsCampagne"));
const palier_1 = __importDefault(require("../models/palier"));
const historiquePoints_1 = __importDefault(require("../models/historiquePoints"));
const projet_1 = __importDefault(require("../models/projet"));
const votes_1 = __importDefault(require("../models/votes"));
const dons_1 = __importDefault(require("../models/dons"));
const produitCategorie_1 = __importDefault(require("../models/produitCategorie"));
const produit_1 = __importDefault(require("../models/produit"));
const produitCommande_1 = __importDefault(require("../models/produitCommande"));
const commandLine_1 = __importDefault(require("../models/commandLine"));
...
class TenantRepository {
    ...
    static destroy(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield association_1.default(options.database).deleteMany({ tenant: id }, options);
            yield mandat_1.default(options.database).deleteMany({ tenant: id }, options);
            yield categorieMouv_1.default(options.database).deleteMany({ tenant: id }, options);
            yield mouvements_1.default(options.database).deleteMany({ tenant: id }, options);
            yield campagne_1.default(options.database).deleteMany({ tenant: id }, options);
            yield detailsCampagne_1.default(options.database).deleteMany({ tenant: id }, options);
            yield palier_1.default(options.database).deleteMany({ tenant: id }, options);
            yield historiquePoints_1.default(options.database).deleteMany({ tenant: id }, options);
            yield projet_1.default(options.database).deleteMany({ tenant: id }, options);
            yield votes_1.default(options.database).deleteMany({ tenant: id }, options);
            yield dons_1.default(options.database).deleteMany({ tenant: id }, options);
            yield produitCategorie_1.default(options.database).deleteMany({ tenant: id }, options);
            yield produit_1.default(options.database).deleteMany({ tenant: id }, options);
            yield produitCommande_1.default(options.database).deleteMany({ tenant: id }, options);
            yield commandLine_1.default(options.database).deleteMany({ tenant: id }, options);
