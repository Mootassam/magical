...
class CategoryRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [record] = yield category_1.default(options.database).create([
    ...
    static findContact(options) {
        return __awaiter(this, void 0, void 0, function* () {
            const record = yield category_1.default(options.database).find();
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            let record = yield mongooseRepository_1.default.wrapWithSessionIfExists(category_1.default(options.database).findOne({
                _id: id,
            ...
            yield category_1.default(options.database).updateOne({ _id: id }, Object.assign(Object.assign({}, data), { updatedBy: mongooseRepository_1.default.getCurrentUser(options).id }), options);
    ...
    static destroy(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield category_1.default(options.database).deleteOne({ _id: id }, options);
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            const records = yield category_1.default(options.database)
                .find({
                _id: { $in: ids },
                tenant: currentTenant.id,
            })
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            return mongooseRepository_1.default.wrapWithSessionIfExists(category_1.default(options.database).countDocuments(Object.assign(Object.assign({}, filter), { tenant: currentTenant.id })), options);
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.slug) {
                    criteriaAnd.push({
                        slug: {
                            $regex: mongooseQueryUtils_1.default.escapeRegExp(filter.slug),
                            $options: "i",
                        },
                    });
                }
                if (filter.metaKeywords) {
                    criteriaAnd.push({
                        metaKeywords: {
                            $regex: mongooseQueryUtils_1.default.escapeRegExp(filter.metaKeywords),
                            $options: "i",
                        },
                    });
                }
                if (filter.metaDescriptions) {
                    criteriaAnd.push({
                        metaDescriptions: {
                            $regex: mongooseQueryUtils_1.default.escapeRegExp(filter.metaDescriptions),
                            $options: "i",
                        },
                    });
                }
            ...
            let rows = yield category_1.default(options.database)
                .find(criteria)
                .skip(skip)
                .limit(limitEscaped)
                .sort(sort);
            const count = yield category_1.default(options.database).countDocuments(criteria);
    ...
    static findAll(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let rows = yield category_1.default(options.database).find({});
            rows = yield Promise.all(rows.map(this._mapRelationshipsAndFillDownloadUrl));
            return { rows };
        });
    }
    ...
    static _createAuditLog(action, id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            yield auditLogRepository_1.default.log({
                entityName: category_1.default(options.database).modelName,
                entityId: id,
                action,
                values: data,
            }, options);
