...
class TenantUserRepository {
    ...
    static createMobile(tenant, user, roles, options) {
        return __awaiter(this, void 0, void 0, function* () {
            roles = 'member';
            const status = selectStatus("active", roles);
            yield user_1.default(options.database).updateMany({ _id: user.id }, {
    ...
    static destroyUser(tenantId, id, options) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static updateRoles(tenantId, id, roles, options, status) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield mongooseRepository_1.default.wrapWithSessionIfExists(user_1.default(options.database).findById(id).populate("tenants.tenant"), options);
    ...
    static acceptInvitation(invitationToken, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let existingTenantUser = currentUser.tenants.find((userTenant) => String(userTenant.tenant.id) === String(invitationTenantUser.tenant.id));
            // destroys old invite just for sure
            yield this.destroyUser(invitationTenantUser.tenant.id, invitationTenantUser.user.id, options);
            const tenantUser = {
