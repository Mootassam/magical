...
class MandatRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [record] = yield mandat_1.default(options.database).create([
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            let record = yield mongooseRepository_1.default.wrapWithSessionIfExists(mandat_1.default(options.database).findById(id), options);
            if (!record ||
                String(record.tenant) !== String(currentTenant.id)) {
                throw new Error404_1.default();
            }
            yield mandat_1.default(options.database).updateOne({ _id: id }, Object.assign(Object.assign({}, data), { updatedBy: mongooseRepository_1.default.getCurrentUser(options).id }), options);
    ...
    static destroy(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield mandat_1.default(options.database).deleteOne({ _id: id }, options);
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            return mongooseRepository_1.default.wrapWithSessionIfExists(mandat_1.default(options.database).countDocuments(Object.assign(Object.assign({}, filter), { tenant: currentTenant.id })), options);
        });
    }
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            let record = yield mongooseRepository_1.default.wrapWithSessionIfExists(mandat_1.default(options.database)
                .findById(id)
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.titre) {
                    criteriaAnd.push({
                        titre: {
                            $regex: mongooseQueryUtils_1.default.escapeRegExp(filter.titre),
                            $options: 'i',
                        },
                    });
                }
            ...
            const criteria = criteriaAnd.length
                ? { $and: criteriaAnd }
                : null;
            let rows = yield mandat_1.default(options.database)
                .find(criteria)
                .skip(skip)
                .limit(limitEscaped)
                .sort(sort)
                .populate('members');
            const count = yield mandat_1.default(options.database).countDocuments(criteria);
    ...
    static findAllAutocomplete(search, limit, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield mandat_1.default(options.database)
                .find(criteria)
                .limit(limitEscaped)
                .sort(sort);
    ...
    static _createAuditLog(action, id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            yield auditLogRepository_1.default.log({
                entityName: mandat_1.default(options.database).modelName,
                entityId: id,
                action,
                values: data,
            }, options);
...
exports.default = MandatRepository;
//# sourceMappingURL=mandatRepository.js.map